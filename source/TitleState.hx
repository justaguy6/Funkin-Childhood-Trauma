...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.frames = Paths.getSparrowAtlas('TraumaLogo');

		logoBl.antialiasing = ClientPrefs.globalAntialiasing;
		logoBl.animation.addByPrefix('bump', 'TraumaLogo move', 24, false);
	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro)
		{
			...
			if(pressedEnter)
			{
				...
				{
					if (mustUpdate) {
						MusicBeatState.switchState(new DemoWarning());
					} else {
						MusicBeatState.switchState(new DemoWarning());
					}
					closedState = true;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Funkin Childhood Trauma'], 15);
					#else
					createCoolText(['saaaas2', 'and many more!']);
					#end
				// credTextShit.visible = true;
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('saaaas2', 15);
					addMoreText('and many more!', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['We are not associated', 'with'], -40);
					#else
				...
				// credTextShit.visible = true;
				case 15:
					addMoreText('Childhood');
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Trauma'); // credTextShit.text += '\nFunkin';
