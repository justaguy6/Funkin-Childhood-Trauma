...
function onCreate()
    precacheImage('stages/idiot/error_popups')

    makeAnimatedLuaSprite('FatalityPopup0','stages/idiot/error_popups',math.random(150,700),math.random(0,screenHeight - 264))
...
function onEvent(name,v1,v2)
    if name == 'Idiot Popup' and PopupCreate == false then
        makeAnimatedLuaSprite('FatalityPopup'..PopupLength + 1,'stages/idiot/error_popups',math.random(150,700),math.random(0,screenHeight - 264))
